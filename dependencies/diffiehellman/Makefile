...
pkgdatadir = $(datadir)/diffiehellman
pkgincludedir = $(includedir)/diffiehellman
pkglibdir = $(libdir)/diffiehellman
pkglibexecdir = $(libexecdir)/diffiehellman
...
PRE_UNINSTALL = :
POST_UNINSTALL = :
DIST_COMMON = $(am__configure_deps) $(srcdir)/DiffieHellman.make \
	$(srcdir)/Makefile.am $(srcdir)/Makefile.in \
	$(srcdir)/diffiehellman.pc.in $(srcdir)/diffiehellman.spec.in \
	$(top_srcdir)/Makefile.include $(top_srcdir)/configure \
	$(top_srcdir)/src/AssemblyInfo.cs.in install-sh missing
subdir = .
...
CONFIG_CLEAN_FILES = src/AssemblyInfo.cs diffiehellman.pc \
	diffiehellman.spec
...
ACLOCAL = ${SHELL} /home/maik/monoworkspace/diffiehellman/missing --run aclocal-1.11
AMTAR = ${SHELL} /home/maik/monoworkspace/diffiehellman/missing --run tar
ASSEMBLY_BUILD = 0
...
ASSEMBLY_KEYNAME = 
ASSEMBLY_LONG_DESCRIPTION = The cryptography classes of the .NET framework lack one crucial class: an implementation of the Diffie-Hellman key agreement algorithm. To fill this gap, we created a completely managed Diffie-Hellman implementation, based on mono::'s BigInteger class.
ASSEMBLY_PACKAGE = DiffieHellman
...
AUTOCONF = ${SHELL} /home/maik/monoworkspace/diffiehellman/missing --run autoconf
...
PACKAGE_BUGREPORT = 
PACKAGE_NAME = DiffieHellman
PACKAGE_STRING = DiffieHellman 0.1
PACKAGE_TARNAME = diffiehellman
PACKAGE_URL = 
PACKAGE_VERSION = 0.1
PATH_SEPARATOR = :
...
STRIP = 
VERSION = 0.1
abs_builddir = /home/maik/monoworkspace/diffiehellman
abs_srcdir = /home/maik/monoworkspace/diffiehellman
abs_top_builddir = /home/maik/monoworkspace/diffiehellman
abs_top_srcdir = /home/maik/monoworkspace/diffiehellman
am__leading_dot = .
...
install_sh = ${SHELL} /home/maik/monoworkspace/diffiehellman/install-sh
...
programfilesdir = ${exec_prefix}/lib/diffiehellman
...
diffiehellman.pc: $(top_builddir)/config.status $(srcdir)/diffiehellman.pc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
diffiehellman.spec: $(top_builddir)/config.status $(srcdir)/diffiehellman.spec.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
